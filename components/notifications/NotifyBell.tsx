...
export default function NotifyBell() {
  ...
  return (
   ...
   <div className="relative group">
      <Link
        href="/notifications"
        className="relative inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-slate-200 dark:bg-orange-500 bg-blue-600 shadow-sm transition hover:bg-slate-500"
        aria-label="Open notifications page"
      >
        <Bell className="h-4 w-4 dark:text-slate-200 text-slate-50" />
        {unreadCount > 0 ? (
      ...
      <div className="invisible absolute right-0 top-full z-50 mt-2 w-90 translate-y-1 rounded-3xl border border-slate-200 bg-white p-2 opacity-0 shadow-xl transition-all duration-150 group-hover:visible group-hover:translate-y-0 group-hover:opacity-100 group-focus-within:visible group-focus-within:translate-y-0 group-focus-within:opacity-100">
